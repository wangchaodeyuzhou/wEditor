...
* 插入图片的 < > 替换 ([5721560](https://github.com/wangchaodeyuzhou/wEditor/commit/57215609ada8b9d15f5505d1ba52e49707b5b183))
* 分割线后无法输入内容 ([146fd05](https://github.com/wangchaodeyuzhou/wEditor/commit/146fd05108592d50d036d0f37a2e29fcdd2a97be))
* 更新各包之间依赖版本 ([75c552c](https://github.com/wangchaodeyuzhou/wEditor/commit/75c552cc8ed54765bebb86a7ec5329a7fc79e85f))
* 更新了 basic-module 依赖版本 ([20c9543](https://github.com/wangchaodeyuzhou/wEditor/commit/20c9543dc9249af6fc7e3a9895ed7f64709ca6ee))
* 禁用时 image 的样式 ([42c993a](https://github.com/wangchaodeyuzhou/wEditor/commit/42c993a7668d90ce049b88a01df21b28912c679f))
* 全选设置字体报错 ([cdb14d1](https://github.com/wangchaodeyuzhou/wEditor/commit/cdb14d10330b5736534e7aaf3a070df2804a8be2))
* 上下标文案显示 ([0e97da1](https://github.com/wangchaodeyuzhou/wEditor/commit/0e97da18279cee6ea06c217972fee4faf9e4758f))
* 修复多选文字且选择空白行无法修改文字样式 ([99a9150](https://github.com/wangchaodeyuzhou/wEditor/commit/99a91509c6e12220bb105cc6d15a0f0a4b375cea))
* 修复清除格式不完全的问题 ([1181a23](https://github.com/wangchaodeyuzhou/wEditor/commit/1181a23e6de71162dc490d9b348379c9b2ef4251))
...
* 有内联元素时对齐失败 ([076c694](https://github.com/wangchaodeyuzhou/wEditor/commit/076c694a4b3474080b89f52692595b84bf4d8207))
...
* code node 顶层 ([a927938](https://github.com/wangchaodeyuzhou/wEditor/commit/a9279388f14212319505f6a5da300cd15e81c214))
* code-block 换行 - 自动加入前面的空格 ([c214032](https://github.com/wangchaodeyuzhou/wEditor/commit/c2140327842d803cd18a9acf47ec3225182bf940))
* color toHtml ([2c9718c](https://github.com/wangchaodeyuzhou/wEditor/commit/2c9718cb2feb4dd0a7bf39238598707fa6d2bb21))
...
* image 拖拽，设置最小值 ([0205023](https://github.com/wangchaodeyuzhou/wEditor/commit/0205023d8c1ec3fafcba3a950afcaef9f5f5170f))
* insert link ([a104682](https://github.com/wangchaodeyuzhou/wEditor/commit/a10468279f730c9a4216474cf3d44d41f124cb6b))
* insertHtml - 空行 ([c61f415](https://github.com/wangchaodeyuzhou/wEditor/commit/c61f415c41d393f203ae5e5c17d9167ec60a1824))
* justify - disable ([3a4b24e](https://github.com/wangchaodeyuzhou/wEditor/commit/3a4b24e8e628024de248f0b52bb4066f626e7480))
* justify indent ([5a81e52](https://github.com/wangchaodeyuzhou/wEditor/commit/5a81e527a45e7a92eb36a2aefa50d93e20c4cec2))
* justify menu disabled ([19e2f80](https://github.com/wangchaodeyuzhou/wEditor/commit/19e2f8008a435101c6ecd4d4a7eadd423cb1070f))
* link 无文本 ([af4fb32](https://github.com/wangchaodeyuzhou/wEditor/commit/af4fb3218bd4651763f66c804fec2b872e99e8f3))
...
* lodash.throttle 引用 bug ([50aeff9](https://github.com/wangchaodeyuzhou/wEditor/commit/50aeff94859bf328346cb9cfe89d0abd57c3b641))
* maxLength - 拼音 + 粘贴 ([3ac4db6](https://github.com/wangchaodeyuzhou/wEditor/commit/3ac4db6d78cbe7a8d1fe19747deb0a17edd9b552))
* menu active ([10829e2](https://github.com/wangchaodeyuzhou/wEditor/commit/10829e2e9e1d864d4900821ee3d5fa516b8cca2a))
...
* **indent menu:** 修复了因为设置 fontSize 导致 text-indent 没法对齐的问题 ([a431d46](https://github.com/wangchaodeyuzhou/wEditor/commit/a431d465ff929b331ebc2545aeb52e7ca3eba2d2))
...
* 兼容 word 文字背景色 ([e820b26](https://github.com/wangchaodeyuzhou/wEditor/commit/e820b26730d34480994a343ab262c043c30a4495))
* 添加链接,空格也会在链接中的问题 ([c656827](https://github.com/wangchaodeyuzhou/wEditor/commit/c65682743bd49eba9ab64be847f1f9527fb6170b))
* 图片 100% 有横向滚动条 ([d21322a](https://github.com/wangchaodeyuzhou/wEditor/commit/d21322a1a9f2e3172a1bd5e175f5ebbb5f2ed074))
...
* 修复光标状态下设置文字样式,菜单不 active 的问题 ([b1b2dba](https://github.com/wangchaodeyuzhou/wEditor/commit/b1b2dbaaae11f74bd36ec79ff50de336c252fef5))
* 修复设置文字颜色与背景色行为与预期不一致的问题 ([25d3381](https://github.com/wangchaodeyuzhou/wEditor/commit/25d3381aa65ce8fe862617e7b1b03cfa5370715d))
* 修复在空字符上插入 link 报错的问题 ([e838f06](https://github.com/wangchaodeyuzhou/wEditor/commit/e838f069f556a5d3206e48a5ed76f8d1e0ae3d05))
* 修复html回显时，部分字体回显问题 ([c83ffa7](https://github.com/wangchaodeyuzhou/wEditor/commit/c83ffa70da655d03bfd639f2d1fd04986440ead2))
* 选中文字，创建链接（同时修改文字） ([5fdf6ae](https://github.com/wangchaodeyuzhou/wEditor/commit/5fdf6ae33b1bebe9b7373e4b7ee8c568480a3c08))
...
* disabled - img 和 todo 可编辑 ([cf6a3f2](https://github.com/wangchaodeyuzhou/wEditor/commit/cf6a3f2a1e05b6231f46aa74c422561e4147f7ae))
...
* emptyP toHtml 增加 br ([c347c29](https://github.com/wangchaodeyuzhou/wEditor/commit/c347c2916416edc96a99d1bf53c0e18cd22d80f9))
* font-size - 支持配置 name value ([206ebd9](https://github.com/wangchaodeyuzhou/wEditor/commit/206ebd994d2635704d93ef9ebe0022d7d72ddea8))
* header 不禁用 bold ([f4cd3d0](https://github.com/wangchaodeyuzhou/wEditor/commit/f4cd3d0b85725701c3ec650e4d6ae7d8831f5105))
* insertHtml - 空行 ([53a8fbb](https://github.com/wangchaodeyuzhou/wEditor/commit/53a8fbb5cf665ef0d6f7fd1c2fee73dba0d98e32))
...
* parse indent style 负数 ([c8d746e](https://github.com/wangchaodeyuzhou/wEditor/commit/c8d746e0464bdda626313c17af4d015681ccc3e8))
* parse-html - sub sup ([2c15a5f](https://github.com/wangchaodeyuzhou/wEditor/commit/2c15a5f9c9c2de8b34770a6bebfe765d203a03f6))
* parse-html pre/code ([d9bd773](https://github.com/wangchaodeyuzhou/wEditor/commit/d9bd773f9a40f9531d9163700253d0b5f717afb8))
* shadow dom 中 modal 输入框异常 ([ef3b199](https://github.com/wangchaodeyuzhou/wEditor/commit/ef3b199a3e74c6b8ba61ed781e1aa13a1c5acfde))
...
* 增加 header4 header5 ([cc48734](https://github.com/wangchaodeyuzhou/wEditor/commit/cc4873412ce3f4de1ecc1dbf4c313094dceb5a77))
...
* insertHtml - text style ([6f303c5](https://github.com/wangchaodeyuzhou/wEditor/commit/6f303c5be81dc8763a28bc982928e5bc9f2936d9))
* link menu config ([fe6b6db](https://github.com/wangchaodeyuzhou/wEditor/commit/fe6b6db62086a5014c25ea96aa9308c2028a5b60))
...
* video menu config ([7fa3783](https://github.com/wangchaodeyuzhou/wEditor/commit/7fa3783c42aa83f7d53c8be34be3c8b7c8a64754))


### Performance Improvements

* 优化较大的svg图片 ([2c360e7](https://github.com/wangchaodeyuzhou/wEditor/commit/2c360e7628eb655e8df67cc7b764f4981b283a2f))
